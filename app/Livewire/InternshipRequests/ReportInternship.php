...
//                    ]);
                ...
                $student->update(['internship_status' => 1]);
            });

            return redirect()->route('dashboard')->with('success', 'Internship reported successfully.');
    ...
    {
        return view('livewire.internship-requests.report-internship');
    }
}
