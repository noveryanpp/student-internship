<div>
    <flux:modal name="report-internship" class="md:w-full">
        <div class="space-y-6">
            <div>
                <flux:heading size="xl">Report Accepted Internship</flux:heading>
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="flex">
                    ...
                    <flux:button type="submit" variant="primary">Create Report</flux:button>
                </div>
            </form>
        </div>
    </flux:modal>
